...
export const AQI_Catagory = (pm: number | null) => {
  if (pm == 0 || pm == null) {
    ...
    return {
      ...
      image: VeryUnhealthy,
      color: "#FD6A6A",
      recommend: "ควรสวมใส่หน้ากากอนามัยและหลีกเลี่ยงกิจกรรมกลางแจ้งทุกชนิดและพื้นที่ๆ มีมลพอิษทางอากาศสูงหากมีอาการทางสุขภาพควรปรึกษาพบแพทย์"
    };
  } else if (pm >= 37.6) {
    return {
      pm: pm,
      ...
      image: Unhealthy,
      color: "#FF9A57",
      recommend: "ควรสวมใส่หน้ากากอนามัยและเลี่ยงกิจกรรมกลางแจ้งทุกชนิดและพื้นที่ๆ มีมลพิษทางอากาศสูงหากมีอาการเช่น ไอ หายใจลำบาก ระคายเคืองตา ควรปรึกษาแพทย์"
    };
  } else if (pm >= 25.1) {
    return {
      pm: pm,
      ...
      image: Moderate,
      color: "#FFD54D",
      recommend: " สามารถทำกิจกรรมกลางแจ้งได้ตามปกติแต่ควรสวมหน้ากากอนามัย หากมีอาการเบื้องต้นเช่น ไอ หายใจลำบาก ระคายเคืองตา ควรปรึกษาแพทย์"
    };
  } else if (pm >= 15.1) {
    return {
      pm: pm,
